    ...
    return (
        <>
            <div className="fixed bottom-[10%] right-[4%] m-4 "
                onClick={toggleChat}
            >
                <div className='bg-[#FFFFFF] w-7 h-7 rounded-full absolute left-10 right-4 flex items-center justify-center'>
                ...
                <div className="bg-[#efc41977] hover:bg-[#EFC31999] text-white font-bold p-4 rounded-full">
                    ...
                    <div className=' pt-3 '>
                        ...
                        <div className='flex flex-row items-center justify-between  '>
                            ...
                            <div className='relative flex flex-row items-center gap-3'>
                                ...
                                <img className='w-12 h-12 rounded-full  ' src={account} alt='none' />
