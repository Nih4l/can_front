                        ...
                        <div className='relative flex py-6 lg:md:px-16 items-center flex-col'>
                            ...
                            <div className='flex flex-row relative pt-5 gap-2 '>
                                ...
                                {(value.length === 4 && value === value1) ?
                                    (
                                        <button className='bg-[#EFC319] text-center py-[6px] px-6 rounded-xl text-white' onClick={handlePin}>Save</button>
                                    )
                                    :
                                    ( <> 
                                        <button className='bg-[#EFC319] text-center py-[6px] px-6 rounded-xl text-white opacity-50 '>Save</button>
