      ...
      <div className='flex flex-col w-full h-screen px-10 bg-[#FFF6FB]'>
        ...
        <div className='flex flex-row justify-between'>
          ...
          <div className='flex flex-col mt-4'>
            ...
            <h2 className="text-black text-[16px] font-medium tracking-wide">agenda, about it, meeting description agenda,</h2>
        ...
        <div className=' flex flex-row py-6 justify-end w-full'>
          <div className='flex flex-row gap-4 justify-center items-center [w-60%]'>
            ...
            <button className='flex justify-center items-center p-2 bg-[#00000020] w-[45px] h-[45px] rounded-[20px] hover:bg-[#EFC319] hover:shadow-lg'><img src={emotions} alt="Emotions" /></button>
