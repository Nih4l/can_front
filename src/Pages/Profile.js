                ...
                <div className='bg-[#FEF8FD] flex flex-col'>
                    ...
                    <div className='bg-white w-[57%]  ml-[13%] h-[52%] mt-8 rounded-2xl shadow-xl relative '>
                        <div className='w-full h-[60%] overflow-hidden'>
                            <img src={Roles_fighter_banner} alt='img.roles.fighter' className='w-full h-full' />
                        ...
                        <div className='rounded-full overflow-hidden absolute top-[40%] left-[10%] w-[20%] h-[%] bg-white flex justify-center items-center '>
                            <div className=''>
                                <img src={account} alt='account.jpg' className='w-[100%] h-[%] p-1 rounded-full' />
                            </div>
                        ...
                        <div className='ml-[30%] w-[] h-[40%] flex pt-2 flex-col mr-4'>
                            ...
                            <div className='flex gap-6 font-semibold h-full items-end '>
                                <h1 className={selected === 'Meeting' ? 'border-b-2 border-[#C31A7F] pb-1' : 'text-[#7E7E7E]'} onClick={() => selectedOption('Meeting')}>Meeting</h1>
                                <h1 className={selected === 'My Story' ? 'border-b-2 border-[#C31A7F] pb-1' : 'text-[#7E7E7E]'} onClick={() => selectedOption('My Story')}>My Story</h1>
                                <h1 className={selected === 'Saved' ? 'border-b-2 border-[#C31A7F] pb-1' : 'text-[#7E7E7E]'} onClick={() => selectedOption('Saved')}>Saved</h1>
                            </div>
                    ...
                    <div className='bg-white w-[57%]  ml-[13%] h-[52%] mt-8 rounded-2xl shadow-xl p-6'>
                        ...
                        <div className='pt-4 w-[40%] relative '
                        ...
                        >
                            ...
                            {details && (<div
                                ...
                                <div className='w-[70%] h-[70%] bg-[#FDF4F9] rounded-3xl flex overflow-hidden'>
                                    ...
                                    {/* Left side (Photo) */}
                                    <div className='w-[60%]'>
                                        <img src={climberEverest} alt='none' className='object-cover h-[100%] w-[100%]' />
                                    </div>
                            ...
                            {/* on Hover */}
                            {isHovered && (<div className='absolute top-0 mt-4 text-white bg-[#00000063] h-[92%] w-full' onClick={ShowDetails}>
                        ...
                        <p className='text-right text-[#1877F2]'>
                            See more
                        </p>
                    </div>
                    ...
                    <div className='bg-white w-[57%]  ml-[13%] h-[52%] mt-8 rounded-2xl shadow-xl p-6'>
                        ...
                        >
                            ...
                            {/* on Hover */}
                            {isHoveredVideo && (<div className='absolute top-0 mt-4 text-white bg-[#00000063] h-[92%] w-full'>
                                <p className='absolute right-2 '>
                                    2w
                                </p>
                                <div className='absolute bottom-0 text-sm'>
                    ...
                    {/* right side */}
                    <div className='w-max pt-8 px-4 h-max absolute right-[9.6%]'>
                        <div>
                    ...
                    <div className='h-[60%] w-[20%] bg-white top-[40%] left-[76%] absolute rounded-2xl shadow-xl overflow-hidden px-2'>
                        ...
                        <div className='flex'>
                            <div className=' w-full'><VerticalSLC /></div>
                        </div>
