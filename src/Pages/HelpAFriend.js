                                ...
                                <div className=' text-center  mb-4'>
                                   <p className=' text-[18px] text-[#000] font-[500] '>Had a good experience?<br/>Share it with the once in need.</p> 
                                    ...
                                    <div className='flex flex-row font-[500] text-[16px]  items-center justify-center'>
                                        <label className=' pl-4  bg-white w-fit rounded-[16px] border-[0.5px] border-[#e1e1e1]' style={{boxShadow:' 0px 10px 30px 0px rgba(0, 0, 0, 0.05)'}}>http://website.com/541254
                                        <button className={` bg-[#EFC319] right-0 text-white font-[500] text-[18px] px-4 py-2 rounded-[16px] ml-10 my-0 cursor-pointer`} style={{boxShadow:'0px 5px 30px rgba(0, 0, 0, 0.05)'}}>Copy</button>
                                        </label>
                                    </div>
                        </div>
           </>
