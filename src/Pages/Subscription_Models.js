...
const SubscriptionModels = () => {
  return (
    ...
    <div className='header'><HomeNav /></div>
        ...
        <div className='absolute left-44 justify-start'><Link to='/home'><BiArrowBack size={24}  className=''/></Link></div>
        <div className='flex flex-col justify-center items-center p-4'>
                <h1 className='text-[black] text-[22px] font-bold '>Choose the Plan that’s right for you</h1>
                <p className='text-[black] text-[16px]  font-semibold'>Subscribers with a verified</p>
        </div>
        </div>
        <div className='flex flex-row justify-evenly gap-7 px-[220px] '>
        
            {/** Model 1 */}
            <div className='flex flex-col w-[400px] h-full bg-[#C31A7F] rounded-[30px] justify-center items-center py-[25px]'style={{boxShadow: '0px 20px 60px 0px #0000001A'}}>
            ...
            }}><h2 className='font-bold text-[18px] px-4'>1 Month</h2></div>
            ...
            {/** Model 2*/}
            <div className='flex flex-col w-[400px] h-full bg-[#084943] rounded-[30px] justify-center items-center py-[25px]'style={{boxShadow: '0px 20px 60px 0px #0000001A'}}>
                ...
                }}><h2 className='font-bold text-[18px] px-4'>6 Month</h2></div>
                <div className='text-white text-[20px] font-bold py-3 '>₹ 275.00</div>
                    <ul className='list-none w-full px-[35px]'>
                        <li className='flex flex-row  text-white text-[14px] gap-4 items-center  leading-[2]'><BsCheck2/>1 Meeting Per Day</li>
                        <li className='flex flex-row  text-white text-[14px] gap-4 items-center  leading-[2]'><BsCheck2/>2 posts Per Day</li>
                        <li className='flex flex-row  text-white text-[14px] gap-4 items-center  leading-[2]'><BsCheck2/>No Featured Posts</li>
            ...
            {/** Model 3 */}
            <div className='flex flex-col w-[400px] h-full bg-[#EFC319] rounded-[30px] justify-center items-center py-[25px]' style={{boxShadow: '0px 20px 60px 0px #0000001A'}}>
            <div className='flex w-[100px] h-[100px] rounded-full bg-white items-center  text-center justify-center shadow-2xl' style={{boxShadow: '0px 5px 20px 0px #0000001A'
