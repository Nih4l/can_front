                        ...
                        <div className=' lg:flex'>
                            ...
                            <div className='bg-[#FEF8FD] lg:px-0 px-2 w-[100%] lg:flex-row lg:flex'>
                                ...
                                <div className='flex flex-col lg:px-16 '>
                                    ...
                                    {createPost ? (
                                        <CreatePost close_createPost={() => setCreatePost(false)} />
                                    ) : (
                                        <div className='bg-white pb-3  mt-8 rounded-[30px] border-[1px] border-solid border-[#D9EAFF] ' style={{
                                            ...
                                            <div className='flex px-10 pt-8 gap-3'   >
                                                ...
                                                <input value={input} onChange={handleInput} placeholder='Write here...' className='w-full outline-none text-[20px ]' />
                                            ...
                                            <div className='flex flex-row pt-4 px-10 justify-between relative'>
                                                <div className='flex flex-row gap-5 items-center relative' >
                                                    <img src={gallery} className='w-5 cursor-pointer' alt='none' onClick={open_post} />
                                                    <img src={gificon} className='w-5 cursor-pointer' alt='none' onClick={toggleGif} />
                                                    <img src={location} className='w-5 cursor-pointer' alt='none' onClick={toggleLocation} />
                                                    <img src={smily} className='w-5 cursor-pointer hover:text-slate-300 ' alt='none' onClick={() => setShowEmoji(!showEmoji)} />
                                                ...
                                                <div className={`${input ? 'bg-[#efc419] text-white p-1 px-6 rounded-xl' : 'bg-[#efc419] opacity-60 text-white p-1 px-6 rounded-xl'}`} >Post</div>
                                            </div>
                                    ...
                                    <div className=' lg:p-7 p-4 mt-8 shrink-0   bg-white rounded-[30px] border-[1px] border-solid border-[#D9EAFF]   ' style={{
                                            ...
                                            <div className='flex  w-full items-center justify-between' >
                                                ...
                                                <div>
                                                    ...
                                                    <div className='flex flex-row items-center gap-2'>
                                                        ...
                                                        <p className='text-[12px] font-semibold text-[#C31A7F]'>Cancer Fighter</p>
                                                    </div>
                                                ...
                                                <div className='flex  items-center justify-between  pb-6' >
                                                    <div className='flex flex-row items-center ' ><BsThreeDots className='cursor-pointer' onClick={threeDotsToggle} /></div>

                                                    {threeDots && (<div className='z-10 w-max h-max bg-white  shadow-2xl absolute top-72 right-8 text-center pt-2 pb-2' ref={threeDotsOutClick}>
                                                        <p className='p-2 px-4 cursor-pointer hover:bg-[#efc4197c]' onClick={toggleBlockTab} >Block Sierra</p>
                                                            ...
                                                            <div className='fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50 lg:p-0 p-2'>
                                                                <div className=' bg-[#FFFFFF] flex flex-col items-center py-10 gap-6 rounded-[30px] px-16 '>
                                                                    ...
                                                                    <div className='flex flex-row items-center gap-5'>
                                                                        <p className='w-20 rounded-lg h-9 bg-transparent border-[#7E7E7E] border-2 flex items-center justify-center text-[14px] text-[#7E7E7E] font-semibold' onClick={toggleBlockTab}>
                                                                            Cancel
                                                                        </p>
                                                                        <p className='w-20 rounded-lg h-9 bg-[#C31A7F] text-[#FFFFFF] flex items-center justify-center text-[14px] font-semibold' onClick={toggleBlockedTab}>
                                                                            Block
                                                                        </p>

                                                                        {userblocked && (
                                                                            <div className='fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50 lg:p-0 p-2'>
                                                                                <div className='bg-[#FFFFFF] flex flex-col items-center py-11 gap-7 rounded-[30px] px-32 relative ' ref={threeDotsOutClick} >
                                                                                    <div className='absolute right-6 top-6  cursor-pointer' >
                                                                                        <IoMdClose size={18} onClick={toggleBlockedTab} />
                                                                                    </div>
                                                                                    <div>
                                                        ...
                                                        <Link to="/profile">
                                                            <p className='p-2 px-4 cursor-pointer hover:bg-[#efc4197c]' >About this account</p>
                                                        </Link>

                                                        <p className='p-2 px-4 cursor-pointer . hover:bg-[#efc4197c]' onClick={toggleReportButton}>Report Sierra Ferguson</p>
                                                        ...
                                                        {reportButton && (
                                                            <div className='fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50 lg:p-0 p-2'>
                                                                <div className='w-[500px] bg-[#FFFFFF] flex flex-col p-7 gap-3 rounded-[30px] relative'>
                                                                    ...
                                                                    <div className='absolute right-6 top-6  cursor-pointer'>
                                                                        <IoMdClose size={18} onClick={toggleReportButton} />
                                                                    </div>
                                                                    <div><hr /></div>
                                                                    ...
                                                                    <div className='flex items-center justify-between text-center'>
                                                                        <p className='text-[14px] font-semibold'>It's a spam</p>
                                                                        <HiOutlineChevronRight className='cursor-pointer' color='#7E7E7E' onClick={togglethanku} />

                                                                        {showThanku && (
                                                                            <div className='fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50 lg:p-0 p-2'>
                                                                                <div className='w-[430px] bg-[#FFFFFF] flex flex-col items-center p-14 gap-7 rounded-[30px]'>

                                                                                    <div><BiCheckCircle color='#C31A7F' size={75} /></div>

                                                                                    <div className='flex flex-col gap-2'>
                                                                                        <h1 className='text-[18px] font-semibold'>Thanks for letting us know</h1>
                                                                                        <p className='text-[14px] text-[#7E7E7E] font-semibold'>Your feedback is important in helping us keep the CAN community safe</p>
                                                                                    </div>



                                                                                    <div className='w-40 h-9 flex items-center justify-center rounded-[10px] bg-[#C31A7F] ' onClick={togglethanku}>
                                                                                        <p className='text-[#FFFFFF] text-[13px] font-semibold cursor-pointer'>Close</p>
                                                                                    </div>
                                                                    ...
                                                                    <div><hr /></div>
                                                                    <div className='flex items-center justify-between text-center'>
                                                                        <p className='text-[14px] font-semibold' >Hate speech or symbols</p>
                                                                        <HiOutlineChevronRight color='#7E7E7E' />
                                                                    </div>
                                                                    <div><hr /></div>
                                                                    <div className='flex items-center justify-between text-center'>
                                                                        <p className='text-[14px] font-semibold' >Violence of dangerous organization</p>
                                                                        <HiOutlineChevronRight color='#7E7E7E' />
                                                                    </div>
                                                                    <div><hr /></div>
                                                                    <div className='flex items-center justify-between text-center'>
                                                                        <p className='text-[14px] font-semibold' >False information</p>
                                                                        <HiOutlineChevronRight color='#7E7E7E' />
                                                                    </div>
                                                                    <div><hr /></div>
                                                                    <div className='flex items-center justify-between text-center'>
                                                                        <p className='text-[14px] font-semibold' >I just don't like it</p>
                                                                        <HiOutlineChevronRight color='#7E7E7E' />
                                                                    </div>
                                                                </div>
                                                            </div>
                                        ...
                                        <div className='pt-5'>
                                            <h1 className='text-[16px] md:text-[24px] font-semibold'>Cancer Survivor Stories: Bethany</h1>
                                            <p className='py-2 text-[#484848] text-[13px] font-semibold text-left md:shrink-0 md:text-left md:text-[14px] '>
                                                ...
                                                {para?.length > 250 && !showFullContent && (
                                                    <button className='text-black font-semibold underline text-[13px] md:text-[14px] cursor-pointer' onClick={handleReadMore}>
                                                        Read More
                                                    </button>
                                                )}
                                            </p>
                                        ...
                                        <div className='pt-3 '>
                                            <div className=' rounded-3xl '>
                                                <img src={climberEverest} alt='none' className='object-cover rounded-3xl h-[200px] md:h-[350px] lg:h-[350px] w-full' />
                                            </div>
                                        </div>
                                        ...
                                        <div className=' pt-7 flex justify-between'>
                                            ...
                                            <div className='flex  items-center gap-7'>
                                                <div className='flex flex-row gap-2 items-center' onClick={likeButton}>
                                                ...
                                                <div>
                                                    <div className='flex flex-row items-center gap-2'>
                                                        <img src={commentIcon} className='w-6 cursor-pointer' alt='none' onClick={toggleContent} />
                                                        <p className='text-[12px] font-bold'>2.2k</p>
                                                    </div>
                                                    ...
                                                    {showContent && (
                                                        <div
                                                            className='fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50 lg:p-0 p-4'
                                                        >
                                                            ...
                                                            <div className='lg:w-[70%] lg:h-[60%]  bg-[#FDF4F9] rounded-3xl flex flex-col lg:flex lg:flex-row overflow-hidden'>
                                                                ...
                                                                <div className='lg:w-[60%] '>
                                                                    <img src={climberEverest} alt='none' className='object-cover w-full h-full' />
                                                                </div>
                                                                ...
                                                                <div className='lg:w-[40%] flex flex-col justify-between gap-4 p-4 relative'>
                                                                    ...
                                                                    <div className=' bottom-4'>
                                                                        <div className='flex gap-3 w-full bg-transparent'>
                                                                            <img src={account} alt='none' className='rounded-full w-[10%] h-[60%] shadow-md ' />
                                                                            <input placeholder='Write here...' className='outline-none w-full bg-transparent ' />
                                                                        </div>
                                                                        <div className='flex justify-between mt-2'>
                                                                            <div className='flex flex-row gap-5 items-center' >
                                                                                <img src={gallery} className='w-5 cursor-pointer' alt='none' />
                                                                                <img src={gificon} className='w-5' alt='none' />
                                                                                <img src={location} className='w-5' alt='none' />
                                                                                <img src={smily} className='w-5' alt='none' />
                                                                            </div>
                                                ...
                                                <div>
                                                    <div className='flex flex-row items-center gap-2'>
                                                        <img className='w-6 cursor-pointer' src={Send} alt='none' onClick={toggleShareButton} />
                                                                ...
                                                                <div className='lg:w-[500px]   w-[350px] bg-[#FFFFFF] flex flex-col gap-5 rounded-[20px]  '>
                                                                    <div>
                                                                        <div className='flex flex-row items-center justify-center relative pt-4 '>
                                                                            <h1 className='text-[16px] font-semibold'>Share with your friends</h1>
                                                                            <div onClick={toggleShareButton} className='absolute right-3 cursor-pointer'>
                                                                                <IoMdClose />
                                                                            </div>
                                                                        </div>
                                                                        <div className=" relative p-4">
                                                                        ...
                                                                        <div className="flex flex-wrap gap-2 items-center justify-center  w-fit h-[50px]  px-3 overflow-y-scroll ">
                                                                            {checked.map((item) => (
                                                                                <div
                                                                                    key={item.id}
                                                                                    className={`h-8 w-36
                                                                                      flex items-center justify-center rounded-[15px] bg-[#c31a7f3c] relative  transition-opacity ease-in-out duration-300 mx-1 text-[12px] font-semibold ${isChecked(item)}`}
                                                                                >
                                                                                    ...
                                                                                    <div className='absolute -right-1 -top-1   bg-[#C31A7F] h-4 w-4 flex items-center justify-center rounded-full cursor-pointer' onClick={() => handleRemoveItem(item)}>
                                                                                        <p className='text-[#FFFFFF] pb-0.5 text-[10px]'>x</p>
                                                                                    </div>
                                                                                    {item.name}
                                                                                </div>
                                                                            ))}
                                                                        ...
                                                                        <div className="h-[200px] overflow-y-scroll ">
                                                                            {checkList.map((item) => (
                                                                                ...
                                                                                <div key={item.id} className='flex py-3 px-3 flex-row items-center justify-between'>

                                                                                    <div className='flex flex-row items-center gap-2 '>
                                                                                        <img src={item.image} className='h-10 w-10 rounded-full' alt={item.name} />
                                                                                        <div className='flex flex-col items-start gap-1  '>
                                                                                            <span className={`${isChecked(item)} text-[14px] font-semibold`}>{item.name}</span>
                                                                                            <span className={`${isChecked(item)} text-[10px] `}>{item.description}</span>
                                                                                        </div>
                                                                    ...
                                                                    <div className='w-full bg-[#FEF8FD] rounded-b-[20px]  '>
                                                                        <div className='p-4 flex flex-row items-center '>
                                                                            <div className='flex flex-row gap-2 items-center w-full'>
                                                                                <img className='h-7 w-7 rounded-full' src={account} alt='none' />
                                ...
                                <div className='lg:flex lg:flex-col lg:gap-4 lg:items-center lg:pr-12 hidden lg:block   '>
                                    ...
                                    <div className=' mt-8 p-5 rounded-[30px]  bg-[#FFFFFF] border-[0.5px] border-[#C31A7F33]'>
                                        ...
                                        <div className='flex flex-col gap-4'>
                                            <div className='flex flex-row items-center justify-center gap-3 pt-3'>
                                                <div className='w-24 h-9 bg-[#C31A7F] text-[#FFFFFF] flex flex-row items-center justify-center rounded-[15px] '><p>8:00</p><p>PM</p>
                                                </div>
                                                <div className='w-24 h-9 bg-[#FFFFFF] text-[#C31A7F] flex flex-row items-center border-[1px] border-[#C31A7F] justify-center rounded-[15px]'><p>9:00</p><p>PM</p>
                                                </div>
                                                <div className='w-24 h-9 bg-[#FFFFFF] text-[#C31A7F] flex flex-row items-center border-[1px] border-[#C31A7F] justify-center rounded-[15px]'><p>12:00</p><p>AM</p>
                                                </div>
                                            </div>
                                    ...
                                    <div className='w-[110%]  px-4  relative'>
                                        <div>
                                            ...
                                            <Link to='/Subscription_Models'>
                                                <div className='w-max absolute top-[70%] left-[12%] bg-gradient-to-r from-[#efc41955] to-[#ed839a54] p-2 px-10 rounded-2xl'>
                                                    View More
                                                </div>
                                            </Link>
                                            ...
                                            <div className='flex flex-col'>
                                                ...
                                                <div className='w-full h-[10%] mt-7 top-[90%] bg-white flex justify-center items-center font-semibold'>
                                                    <div className='bg-[#c31a7f3c] flex items-center h-10 gap-2 pl-2 rounded-3xl'>
                                                        ...
                                                        {vertical === 'Upcoming' &&
                                                            (
                                                                <div className='flex flex-row px-4 items-center text-[15px]'>
                                                        ...
                                                        {vertical === 'Medicines' && (
                                                            <div className='flex flex-row px-4 ite-center test-[15px]'>
