            ...
            <>
              <div className="pl-[10%] pr-[6%] ">
                <div className="bg-white shadow-xl mt-8 flex justify-between px-10 rounded-2xl py-2">
                  <div className="flex items-center font-semibold text-[#CF4899]  w-[10%]">
                    11:00 - 12:15PM
                  </div>
                  ...
                  <div className="flex items-center">
                    <h2
                      className="bg-[#EFC319] text-white px-8 py-1 rounded-xl"
                      onClick={joinMeeting}
                    >
                      Join
                    </h2>
                ...
                <div className="w-full flex justify-end">
                  <h1 className="text-right px-4 mr-10 bg-[#efc41949] text-[#EFC319] rounded-xl w-max mt-3">
                    View all
                  </h1>
                </div>
              </div>
