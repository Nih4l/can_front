                ...
                <div className='flex'>
                    ...
                    <div className='h-[100vh] flex items-center'>
                        <div className='h-[90%] w-[60vh] shadow-xl mx-24 bg-[#D9D9D9] bg-opacity-10 z-10 backdrop-blur-lg rounded-md'>
                            ...
                            <div className='text-center text-3xl font-semibold p-2 text-[#EFC319]'>
                            ...
                            <div className='flex justify-center pt-12'>
                                ...
                                {data && check ?
                                    (<Link to='/loginotp' className='w-[80%] text-center'>
                                        <h2 className='bg-[#EFC319] p-3 my-3 rounded-xl text-white'>Continue</h2>
                                    </Link>)
                                    :
                                    (
                                        <div className='w-[80%] text-center'>
                                            <h2 className='bg-[#EFC319] p-3 my-3 rounded-xl text-white opacity-50'>Continue</h2>
                                        </div>
                                    )
                                }
