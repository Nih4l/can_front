    ...
    <div className="bg-[#FEF8FD] min-h-screen">
      ...
      <div className="pt-20  ">
        <div className="flex flex-row  justify-center items-center gap-8  ">
          ...
          >
            <div className="bg-[#084943] text-[18px] flex flex-row justify-start  items-center text-white gap-2 py-3 px-10 font-[600] rounded-t-[30px]">
            ...
            <div className="flex flex-row rounded-[30px]  items-center ">
              {/** Icons */}
                  ...
                  <div className="pt-2">
                    ...
                    <div className="flex flex-row gap-4 items-center">
                      <input
                        ...
                        className="border-2  w-full rounded-[20px] p-3 text-[20px]"
                      />
                      <BiCheckCircle className="text-[30px]" />
                    </div>
                  </div>

                  <div className="flex flex-row flex-nowrap gap-2 pt-4">
                    <div>
                      <label className=" pl-4 text-[20px] text-[#9B9B9B]">
                        Expiration Date
                      </label>
                  ...
                  <div className="">
                    ...
                    <div className="flex flex-row gap-4 items-center">
                      <input
                        ...
                        className="border-2 w-full rounded-[20px] p-3 text-[18px]"
                      />
                      <BiCheckCircle className="text-[30px]" />
                    </div>
                  </div>
      ...
      <div className="py-8 ">
        <p className="text-[14px] font-semibold  text-[#696969] py-18">
          <center>
            ...
            <Link to="#" className=" underline font-semibold text-black">
              Terms of Service
            </Link>{" "}
            and{" "}
            <Link to="#" className=" underline font-semibold text-black">
